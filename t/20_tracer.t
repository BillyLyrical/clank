...
subtest 'Start and end span' => sub {
    my $t = Clank::Tracer->new(store => Clank::Store->new(db => ':memory:'));
...
subtest 'Nested spans with parent_id' => sub {
    ...
    my $t = Clank::Tracer->new(store => $store2);
...
subtest 'Query with filters' => sub {
    ...
    my $t = Clank::Tracer->new(store => $store3);
...
subtest 'Query with min_duration' => sub {
    ...
    my $t = Clank::Tracer->new(store => $store4);
...
subtest 'Stats' => sub {
    ...
    my $t = Clank::Tracer->new(store => $store5);
...
subtest 'Trace tree' => sub {
    ...
    my $t = Clank::Tracer->new(store => $store6);
...
subtest 'Auto-subscribe traces bus events' => sub {
    ...
    require Clank::Bus;
    my $bus = Clank::Bus->new(store => $store7);

    my $t = Clank::Tracer->new(store => $store7, bus => $bus, auto_subscribe => 1);
...
subtest 'Metadata persisted and retrieved' => sub {
    ...
    my $t = Clank::Tracer->new(store => $store8);

...
subtest 'Construction' => sub {
    my $tx = Clam::Taxonomy->new(world_model => $wm);
    isa_ok($tx, 'Clam::Taxonomy');
    my $s = $tx->stats;
...
subtest 'Create root category' => sub {
    my $tx = Clam::Taxonomy->new(world_model => Clam::WorldModel->new(store => Clam::Store->new(db => ':memory:')));
...
subtest 'entities_in_category' => sub {
    ...
    my $tx = Clam::Taxonomy->new(world_model => $wm2);

...
subtest 'Construction' => sub {
    my $tx = Clank::Logic::Taxonomy->new(world_model => $wm);
    isa_ok($tx, 'Clank::Logic::Taxonomy');
    my $s = $tx->stats;
...
subtest 'Create root category' => sub {
    my $tx = Clank::Logic::Taxonomy->new(world_model => Clank::WorldModel->new(store => Clank::Store->new(db => ':memory:')));
...
subtest 'entities_in_category' => sub {
    ...
    my $tx = Clank::Logic::Taxonomy->new(world_model => $wm2);

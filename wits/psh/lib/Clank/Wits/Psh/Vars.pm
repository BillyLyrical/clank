...
# CLANK-WIT: about=Manage psh variables — list, get, set, clear, export
# CLANK-WIT: usage=Input: { action: "list" } or { action: "get", name: "auth" } or { action: "set", name: "x", value: "42" } Output: { vars: {...}, count: N }
# CLANK-WIT: hint=psh_vars, variables, list, get, set, clear
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Psh::Vars;
use strict;
use warnings;

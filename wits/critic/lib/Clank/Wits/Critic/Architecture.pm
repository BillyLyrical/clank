# CLANK-WIT: name=Architecture
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Critique code architecture — structure, coupling, separation of concerns
# CLANK-WIT: usage=Input: { text: "sub process { ... open ... print ... if ... for ... }" } Output: { score: 4, issues: [...], suggestions: [...] }
# CLANK-WIT: hint=critic_architecture, architecture, coupling, separation of concerns
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Critic::Architecture;
use strict;
use warnings;

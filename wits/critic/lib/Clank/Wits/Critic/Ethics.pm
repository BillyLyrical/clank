# CLANK-WIT: name=Ethics
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Critique code ethics — fairness, bias, privacy, consent
# CLANK-WIT: usage=Input: { text: "sub filter_users { return grep { $_->{age} > 18 } @users; }" } Output: { score: 6, issues: [...], suggestions: [...] }
# CLANK-WIT: hint=critic_ethics, ethics, bias, privacy, consent, dark patterns
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Critic::Ethics;
use strict;
use warnings;

# CLANK-WIT: name=Sustainability
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Critique code sustainability — maintainability, long-term viability
# CLANK-WIT: usage=Input: { text: "sub legacy_process { ... } # 500 lines of uncommented code" } Output: { score: 3, issues: [...], suggestions: [...] }
# CLANK-WIT: hint=critic_sustainability, sustainability, maintainability, technical debt
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Critic::Sustainability;
use strict;
use warnings;

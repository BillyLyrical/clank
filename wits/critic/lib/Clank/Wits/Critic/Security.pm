# CLANK-WIT: name=Security
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Critique code security — vulnerabilities, secrets, injection risks
# CLANK-WIT: usage=Input: { text: "system(\"rm -rf $dir\")" } Output: { score: 2, issues: [...], suggestions: [...] }
# CLANK-WIT: hint=critic_security, security, vulnerabilities, secrets, injection
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Critic::Security;
use strict;
use warnings;

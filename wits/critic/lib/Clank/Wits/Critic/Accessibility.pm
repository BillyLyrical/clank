# CLANK-WIT: name=Accessibility
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Critique code accessibility — screen readers, keyboard nav, color contrast
# CLANK-WIT: usage=Input: { text: "<button onclick='submit()'>Click here</button>", type: "html" } Output: { score: 4, issues: [...], suggestions: [...] }
# CLANK-WIT: hint=critic_accessibility, accessibility, WCAG, screen reader, keyboard
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Critic::Accessibility;
use strict;
use warnings;

# CLANK-WIT: name=Frugality
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Critique code frugality — resource usage, efficiency, waste reduction
# CLANK-WIT: usage=Input: { text: "my @data = map { process($_) } @huge_list; my @sorted = sort @data;" } Output: { score: 5, issues: [...], suggestions: [...] }
# CLANK-WIT: hint=critic_frugality, frugality, resource usage, waste, efficiency
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Critic::Frugality;
use strict;
use warnings;

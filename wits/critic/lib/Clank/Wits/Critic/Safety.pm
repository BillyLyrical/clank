# CLANK-WIT: name=Safety
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Critique code safety — error handling, edge cases, resource leaks
# CLANK-WIT: usage=Input: { text: "open my $fh, '<', $file;" } Output: { score: 5, issues: [...], suggestions: [...] }
# CLANK-WIT: hint=critic_safety, safety, error handling, resource leaks
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Critic::Safety;
use strict;
use warnings;

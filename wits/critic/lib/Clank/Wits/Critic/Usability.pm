# CLANK-WIT: name=Usability
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Critique code usability — API design, error messages, developer experience
# CLANK-WIT: usage=Input: { text: "sub process { my ($data, $format, $encoding, $strict) = @_; ... }" } Output: { score: 5, issues: [...], suggestions: [...] }
# CLANK-WIT: hint=critic_usability, usability, API design, error messages, DX
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Critic::Usability;
use strict;
use warnings;

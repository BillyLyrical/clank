# CLAM-WIT: name=Performance
# CLAM-WIT: version=1.0.0
# CLAM-WIT: about=Critique code performance — speed, memory, efficiency
# CLAM-WIT: usage=Input: { text: "for my $item (@list) { for my $other (@list) { ... } }" } Output: { score: 5, issues: [...], suggestions: [...] }
# CLAM-WIT: hint=critic_performance, performance, speed, memory, efficiency
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Critic::Performance;
use strict;
use warnings;

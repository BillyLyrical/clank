# CLAM-WIT: name=Clarity
# CLAM-WIT: version=1.0.0
# CLAM-WIT: about=Critique code clarity — readability, naming, documentation
# CLAM-WIT: usage=Input: { text: "sub f { my $x = shift; return $x * 2; }" } Output: { score: 5, issues: [...], suggestions: [...] }
# CLAM-WIT: hint=critic_clarity, clarity, readability, naming, documentation
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Critic::Clarity;
use strict;
use warnings;

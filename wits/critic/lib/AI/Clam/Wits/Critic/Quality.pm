# CLAM-WIT: name=Quality
# CLAM-WIT: version=1.0.0
# CLAM-WIT: about=Critique code quality — error handling, best practices, maintainability
# CLAM-WIT: usage=Input: { text: "sub foo { open my $fh, '<', $file; ... }" } Output: { score: 6, issues: [...], suggestions: [...] }
# CLAM-WIT: hint=critic_quality, quality, error handling, best practices
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Critic::Quality;
use strict;
use warnings;

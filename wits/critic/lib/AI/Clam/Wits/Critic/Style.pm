...
# CLAM-WIT: about=Critique code style — formatting, conventions, idioms
# CLAM-WIT: usage=Input: { text: "sub foo{\nmy $x=1;\nreturn $x;\n}" } Output: { score: 4, issues: [...], suggestions: [...] }
# CLAM-WIT: hint=critic_style, code style, formatting, conventions
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Critic::Style;
use strict;
use warnings;

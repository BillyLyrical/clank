...
# CLANK-WIT: about=Web search provider: Kagi Search API (paid, no ads)
# CLANK-WIT: usage=Input: { action: "search", query: "Perl tie IPC", limit: 5 } Output: { results: [{ content, url, title, provenance }] }
# CLANK-WIT: hint=search_kagi, Kagi, web search, paid search, no ads
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Search::Kagi;
use strict;
use warnings;

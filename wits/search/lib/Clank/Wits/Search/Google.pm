# CLANK-WIT: name=Google
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Web search provider: Google Custom Search API
# CLANK-WIT: usage=Input: { action: "search", query: "Perl tie IPC", limit: 5 } Output: { results: [{ content, url, title, provenance }] }
# CLANK-WIT: hint=search_google, Google, web search, Custom Search API
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Search::Google;
use strict;
use warnings;

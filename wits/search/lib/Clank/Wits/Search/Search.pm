...
# CLANK-WIT: about=General-purpose context gatherer: parallel search across pluggable providers
# CLANK-WIT: usage=Input: { action: "search", query: "how to fix Perl IPC" } or { action: "register", provider: "web", weight: 0.3 } or { action: "providers" } Output: { results: [...], count, cached }
# CLANK-WIT: hint=search, search orchestrator, providers, fan-out, merge, rank, dedup
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Search::Search;
use strict;
use warnings;

# CLANK-WIT: name=Yandex
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Web search provider: Yandex XML Search API
# CLANK-WIT: usage=Input: { action: "search", query: "Perl tie IPC", limit: 5 } Output: { results: [{ content, url, title, provenance }] }
# CLANK-WIT: hint=search_yandex, Yandex, web search, Russian, Eastern European
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Search::Yandex;
use strict;
use warnings;

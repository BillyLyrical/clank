# CLANK-WIT: name=Duckduckgo
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Web search provider: DuckDuckGo instant answers and results
# CLANK-WIT: usage=Input: { action: "search", query: "Perl tie IPC", limit: 5 } Output: { results: [{ content, url, title, provenance }] }
# CLANK-WIT: hint=search_duckduckgo, DuckDuckGo, web search, instant answers, no API key
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Search::Duckduckgo;
use strict;
use warnings;
    ...
    $api->register_tool(
        ...
        execute => sub {
            ...
            if ($action eq 'search') {
                ...
                my $ua = 'Clank/1.0 (search provider)';
                my $response = '';

...
# CLAM-WIT: about=Local data provider: searches wiki, diary, journal, discoveries, rollodex
# CLAM-WIT: usage=Input: { action: "search", query: "Alice", limit: 10 } Output: { results: [{ content, provenance }] }
# CLAM-WIT: hint=search_local, local search, wiki, diary, rollodex, user data
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Search::Local;
use strict;
use warnings;

...
# CLAM-WIT: about=LLM search provider: queries local LLM for analysis, summaries, answers
# CLAM-WIT: usage=Input: { action: "search", query: "explain Perl tie() for IPC", limit: 3 } Output: { results: [{ content, provenance }] }
# CLAM-WIT: hint=search_llm, LLM, local LLM, analysis, summaries, knowledge
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Search::Llm;
use strict;
use warnings;

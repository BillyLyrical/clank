# CLANK-WIT: name=TestGen
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Generate test skeletons from function signatures
# CLANK-WIT: usage=Input: { code: "sub add { my ($a, $b) = @_; return $a + $b; }" } Output: { tests: [...], names: [...] }
# CLANK-WIT: hint=perl_test_gen, test generation, test skeleton, Test::More
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Perl::TestGen;
use strict;
use warnings;

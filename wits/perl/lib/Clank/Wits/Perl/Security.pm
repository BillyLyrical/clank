...
# CLANK-WIT: about=Find unsafe Perl patterns (system, eval, no taint)
# CLANK-WIT: usage=Input: { code: "system($user_input); eval $code;" } Output: { issues: [{ type: "taint", msg: "...", severity: "critical" }] }
# CLANK-WIT: hint=perl_security, security, taint mode, unsafe patterns
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Perl::Security;
use strict;
use warnings;

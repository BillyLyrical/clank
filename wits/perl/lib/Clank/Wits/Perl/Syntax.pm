# CLANK-WIT: name=Syntax
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Check Perl syntax with perl -c, return errors/warnings
# CLANK-WIT: usage=Input: { code: "sub foo { my $x = }", file: "test.pl" } Output: { ok: 0, errors: [...] }
# CLANK-WIT: hint=perl_syntax, syntax check, perl -c, compile errors
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Perl::Syntax;
use strict;
use warnings;

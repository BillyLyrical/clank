# CLANK-WIT: name=Refactor
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Suggest refactoring improvements for Perl code
# CLANK-WIT: usage=Input: { code: "sub foo { if ($x) { return 1; } else { return 0; } }" } Output: { suggestions: [{ type: "simplify", before: "...", after: "..." }] }
# CLANK-WIT: hint=perl_refactor, refactoring, code improvement, modernize
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Perl::Refactor;
use strict;
use warnings;

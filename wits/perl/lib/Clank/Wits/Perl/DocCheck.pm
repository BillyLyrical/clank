# CLANK-WIT: name=DocCheck
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Verify POD validity, find missing documentation
# CLANK-WIT: usage=Input: { code: "=head1 NAME\n\nMy module\n\n=cut\n\nsub foo { }" } Output: { valid: 1, missing: [...], sections: [...] }
# CLANK-WIT: hint=perl_doc_check, POD validation, documentation check, undocumented
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Perl::DocCheck;
use strict;
use warnings;

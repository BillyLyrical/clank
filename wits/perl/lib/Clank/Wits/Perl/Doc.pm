...
# CLANK-WIT: about=Extract or generate POD documentation for Perl code
# CLANK-WIT: usage=Input: { code: "sub foo { ... }", action: "extract" } Output: { pod: "=head1 foo\n\n..." }
# CLANK-WIT: hint=perl_doc, POD, documentation, extract, generate
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Perl::Doc;
use strict;
use warnings;

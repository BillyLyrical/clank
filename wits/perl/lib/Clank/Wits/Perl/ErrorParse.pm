# CLANK-WIT: name=ErrorParse
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Parse Perl error messages and suggest fixes
# CLANK-WIT: usage=Input: { error: "Can't call method 'foo' on unblessed reference at script.pl line 42" } Output: { type: "bless", suggestion: "...", line: 42 }
# CLANK-WIT: hint=perl_error_parse, error parsing, error messages, fix suggestions
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Perl::ErrorParse;
use strict;
use warnings;

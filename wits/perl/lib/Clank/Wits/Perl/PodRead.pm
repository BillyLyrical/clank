# CLANK-WIT: name=PodRead
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Read Perl module POD: extract subs, docs, interface
# CLANK-WIT: usage=Input: { module: "Clank::Memory" } or { file: "/path/to/Module.pm", subs: 1 } Output: { subs: [...], pod: "...", stats: {...} }
# CLANK-WIT: hint=pod_read, POD reader, module interface, extract subs
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Perl::PodRead;
use strict;
use warnings;
...
sub register {
    ...
    $api->register_tool(
        ...
        parameters  => {
            type       => 'object',
            properties => {
                module  => { type => 'string', description => 'Module name (e.g. Clank::Memory)' },

# CLANK-WIT: name=Explain
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Explain what Perl code does in plain English
# CLANK-WIT: usage=Input: { code: "my @sorted = sort { $a <=> $b } @unsorted;" } Output: { explanation: "This sorts the array numerically in ascending order." }
# CLANK-WIT: hint=perl_explain, explain code, plain English, code reading
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Perl::Explain;
use strict;
use warnings;

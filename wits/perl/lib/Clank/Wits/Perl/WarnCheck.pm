# CLANK-WIT: name=WarnCheck
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Find potential Perl warnings, suggest fixes
# CLANK-WIT: usage=Input: { code: "print $x; my $y = $undefined;" } Output: { warnings: [{ type: "uninitialized", line: 1, msg: "..." }] }
# CLANK-WIT: hint=perl_warn_check, warnings, uninitialized, static analysis
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Perl::WarnCheck;
use strict;
use warnings;

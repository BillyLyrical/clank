...
# CLAM-WIT: about=Run Perl tests and parse TAP output
# CLAM-WIT: usage=Input: { file: "t/01_test.t" } or { dir: "t/" } Output: { passed: 10, failed: 2, total: 12, errors: [...] }
# CLAM-WIT: hint=perl_test, run tests, prove, TAP output
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Perl::Test;
use strict;
use warnings;

# CLAM-WIT: name=DeadCode
# CLAM-WIT: version=1.0.0
# CLAM-WIT: about=Find unused subroutines and variables in Perl code
# CLAM-WIT: usage=Input: { code: "sub used { } sub unused { } my $x = 1;" } Output: { unused_subs: ["unused"], unused_vars: ["$x"] }
# CLAM-WIT: hint=perl_dead_code, unused code, dead code, unused subs, unused variables
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Perl::DeadCode;
use strict;
use warnings;

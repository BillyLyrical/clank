...
# CLAM-WIT: usage=Input: { module: "AI::Clam::Memory" } or { file: "/path/to/Module.pm", subs: 1 } Output: { subs: [...], pod: "...", stats: {...} }
# CLAM-WIT: hint=pod_read, POD reader, module interface, extract subs
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Perl::PodRead;
use strict;
use warnings;
...
sub register {
    ...
    $api->register_tool(
        ...
        parameters  => {
            type       => 'object',
            properties => {
                module  => { type => 'string', description => 'Module name (e.g. AI::Clam::Memory)' },

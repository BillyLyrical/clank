# CLAM-WIT: name=Embedding
# CLAM-WIT: version=1.0.0
# CLAM-WIT: about=Semantic search via vector embeddings. Requires an embedding provider (Ollama, OpenAI).
# CLAM-WIT: usage=Input: { action: "search", query: "what causes rain", limit: 5 } Output: { results: [{ id, name, score }] }
# CLAM-WIT: hint=embedding, semantic search, vector, cosine similarity
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Embedding::Embedding;
use strict;
use warnings;

...
# CLANK-WIT: about=Solve a Constraint Satisfaction Problem end-to-end
# CLANK-WIT: usage=Input: { variables: { X1: [1,2,3], X2: [1,2,3] }, constraints: [...] } Output: { ok: true, sat: true, solution: {X1: 1, X2: 3} }
# CLANK-WIT: hint=sat_csp, csp, constraint_satisfaction, nqueens, sudoku, graph_coloring
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Logic::Sat::Csp;
use strict;
use warnings;

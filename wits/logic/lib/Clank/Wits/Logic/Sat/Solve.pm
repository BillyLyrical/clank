# CLANK-WIT: name=Solve
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Run picosat on DIMACS CNF and parse result
# CLANK-WIT: usage=Input: { dimacs: "p cnf 3 2\n1 2 0\n-1 3 0\n" } Output: { ok: true, sat: true, assignments: {1: 1, 2: 1, 3: -1} }
# CLANK-WIT: hint=sat_solve, sat, solver, picosat, dimacs, cnf, satisfiability
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
# NEEDS REVIEW: previous test used excessive RAM — do not re-enable until memory usage is profiled and bounded.
package Clank::Wits::Logic::Sat::Solve;
use strict;
use warnings;

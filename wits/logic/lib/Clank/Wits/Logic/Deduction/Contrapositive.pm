# CLANK-WIT: name=Contrapositive
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Refute by contradiction — if conclusion is false, premise must be false
# CLANK-WIT: usage=Input: { rule: { if: "code has strcpy", then: "overflow risk" }, conclusion_negated: true } Output: { refuted: true, premise_false: "...", valid: true }
# CLANK-WIT: hint=deduction_contrapositive, contrapositive, refutation, modus_tollens, contradiction
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Logic::Deduction::Contrapositive;
use strict;
use warnings;

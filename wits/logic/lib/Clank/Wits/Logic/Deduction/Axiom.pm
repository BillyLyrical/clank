# CLANK-WIT: name=Axiom
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=State an axiom — an accepted truth requiring no justification
# CLANK-WIT: usage=Input: { truth: "Functions must have no side effects", source: "AGENTS.md" } Output: { axiom_id: 1, truth: "...", certainty: "certain" }
# CLANK-WIT: hint=deduction_axiom, axiom, truth, foundation, accepted
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Logic::Deduction::Axiom;
use strict;
use warnings;

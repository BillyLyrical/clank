# CLANK-WIT: name=Given
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=State a given — a specific premise for this case
# CLANK-WIT: usage=Input: { fact: "this code contains strcpy(buf, input)", context: "c/security.wit" } Output: { given_id: 1, fact: "...", certainty: "contingent" }
# CLANK-WIT: hint=deduction_given, given, premise, fact, case
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Logic::Deduction::Given;
use strict;
use warnings;

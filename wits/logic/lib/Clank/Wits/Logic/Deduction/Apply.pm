# CLANK-WIT: name=Apply
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Apply a rule to premises — derive a conclusion
# CLANK-WIT: usage=Input: { rule: { if: "code has strcpy", then: "overflow risk" }, premises: [{ fact: "code has strcpy(buf, input)" }] } Output: { conclusion: "overflow risk", certainty: "contingent", valid: true }
# CLANK-WIT: hint=deduction_apply, apply, derive, conclusion, modus_ponens
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Logic::Deduction::Apply;
use strict;
use warnings;

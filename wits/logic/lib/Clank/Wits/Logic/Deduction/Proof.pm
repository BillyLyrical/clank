# CLANK-WIT: name=Proof
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Record and validate a proof — the derivation path with logical form
# CLANK-WIT: usage=Input: { steps: [...], conclusion: "..." } Output: { proof_id: 1, steps: [...], valid: true, length: N }
# CLANK-WIT: hint=deduction_proof, proof, derivation, trace, validation
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Logic::Deduction::Proof;
use strict;
use warnings;

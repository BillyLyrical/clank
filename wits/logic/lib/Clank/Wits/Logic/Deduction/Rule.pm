...
# CLANK-WIT: about=State an inference rule — if P then Q
# CLANK-WIT: usage=Input: { if: "code contains strcpy", then: "potential buffer overflow", name: "strcpy_overflow" } Output: { rule_id: 1, if: "...", then: "...", valid: true }
# CLANK-WIT: hint=deduction_rule, inference, rule, if_then, implication
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Logic::Deduction::Rule;
use strict;
use warnings;

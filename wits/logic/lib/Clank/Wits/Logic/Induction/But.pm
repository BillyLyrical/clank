...
# CLANK-WIT: about=Raise an objection or caveat to a conclusion
# CLANK-WIT: usage=Input: { conclusion: "...", exception: "...", strength: 0.0-1.0 } Output: { revised: "...", strength: 0.0-1.0, objection: "..." }
# CLANK-WIT: hint=induction_but, but, objection, caveat, challenge, exception
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Logic::Induction::But;
use strict;
use warnings;

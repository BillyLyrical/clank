# CLANK-WIT: name=Because
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=State a causal relationship — X because Y
# CLANK-WIT: usage=Input: { effect: "server crashed", cause: "OOM", strength: 0.9, evidence: [...] } Output: { because_id: 1, effect: "...", cause: "...", strength: 0.9, causal_link: "server crashed because OOM" }
# CLANK-WIT: hint=induction_because, because, causal, cause_effect, causation
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Logic::Induction::Because;
use strict;
use warnings;

...
# CLANK-WIT: about=State a fact — an observation, data point, or measurement
# CLANK-WIT: usage=Input: { data: "module X has 500 lines", source: "wc -l" } Output: { fact_id: 1, data: "...", source: "...", timestamp: "..." }
# CLANK-WIT: hint=induction_fact, fact, observation, data, measurement
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Logic::Induction::Fact;
use strict;
use warnings;

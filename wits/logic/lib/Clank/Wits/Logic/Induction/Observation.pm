# CLANK-WIT: name=Observation
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Record a meta-observation about the reasoning process
# CLANK-WIT: usage=Input: { about: "the pattern repeats across modules", insight: "This suggests a systemic issue" } Output: { observation_id: 1, about: "...", insight: "..." }
# CLANK-WIT: hint=induction_observation, observation, meta, insight, reasoning
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Logic::Induction::Observation;
use strict;
use warnings;

...
# CLANK-WIT: about=Logical XOR — exactly one condition must be truthy
# CLANK-WIT: usage=Input: { conditions: [true, false] } or { a: 1, b: 0 } Output: { result: true, truthy_count: 1, count: 2 }
# CLANK-WIT: hint=induction_xor, xor, exclusive, logical, mutual_exclusion
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Logic::Induction::Xor;
use strict;
use warnings;

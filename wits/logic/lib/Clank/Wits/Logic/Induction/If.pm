...
# CLANK-WIT: about=Conditional branching — evaluate a condition and return the appropriate branch
# CLANK-WIT: usage=Input: { condition: "fact_count > 3", then: "strong pattern", else: "weak signal" } Output: { branch: "then"|"else", result: "...", evaluated: true|false }
# CLANK-WIT: hint=induction_if, if, conditional, branching, condition
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Logic::Induction::If;
use strict;
use warnings;

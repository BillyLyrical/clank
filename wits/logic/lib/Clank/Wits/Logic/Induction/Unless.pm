# CLANK-WIT: name=Unless
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Execute the else branch when a condition is falsy
# CLANK-WIT: usage=Input: { condition: false, unless: "fallback value" } Output: { triggered: true|false, result: "...", condition: "..." }
# CLANK-WIT: hint=induction_unless, unless, fallback, negated_condition
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Logic::Induction::Unless;
use strict;
use warnings;

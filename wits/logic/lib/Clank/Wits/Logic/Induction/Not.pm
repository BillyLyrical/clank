...
# CLANK-WIT: about=Negate a value or condition
# CLANK-WIT: usage=Input: { value: true } or { value: 0 } Output: { negated: false, original: true, type: "boolean" }
# CLANK-WIT: hint=induction_not, not, negate, logical, negation
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Logic::Induction::Not;
use strict;
use warnings;

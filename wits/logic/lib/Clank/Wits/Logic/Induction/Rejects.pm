# CLANK-WIT: name=Rejects
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Logical rejection — A rejects B (A is incompatible with B)
# CLANK-WIT: usage=Input: { a: true, b: false } Output: { result: true, a: true, b: false, description: "A rejects B" }
# CLANK-WIT: hint=induction_rejects, rejects, incompatible, conflict, mutual_exclusion
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Logic::Induction::Rejects;
use strict;
use warnings;

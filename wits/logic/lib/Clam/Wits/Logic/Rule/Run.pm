...
# CLAM-WIT: about=Run the shared ruleset against text: pattern/fuzzy classification with confidence scores
# CLAM-WIT: usage=Input: { text: str, strategy?: first|all, dsl?: str } Output: { ok: 1, matched: 0|1, rule?, confidence?, result? }
# CLAM-WIT: hint=rule_run, run, ruleset, classify, match, execute
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package Clam::Wits::Logic::Rule::Run;
use strict;
use warnings;

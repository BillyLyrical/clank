...
# CLAM-WIT: about=Add a classification rule to the shared ruleset
# CLAM-WIT: usage=Input: { dsl?: str } or { name: str, when: str, then?: [str], priority?: int, domain?: str } Output: { ok: 1, rule: name, total_rules: N } or { ok: 0, error: str }
# CLAM-WIT: hint=rule_add, add, rule, dsl, classify, persist
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package Clam::Wits::Logic::Rule::Add;
use strict;
use warnings;

# CLAM-WIT: name=Theorem
# CLAM-WIT: version=1.0.0
# CLAM-WIT: about=State a theorem — a rule, principle, or heuristic
# CLAM-WIT: usage=Input: { principle: "YAGNI: don't add code until needed", when: "design review" } Output: { theorem_id: 1, principle: "...", when: "...", confidence: 1.0 }
# CLAM-WIT: hint=induction_theorem, theorem, principle, rule, heuristic
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Logic::Induction::Theorem;
use strict;
use warnings;

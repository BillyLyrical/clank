...
# CLAM-WIT: about=Logical OR — at least one condition must be truthy
# CLAM-WIT: usage=Input: { conditions: [false, false, true] } or { a: 0, b: 1, c: 0 } Output: { result: true, truthy_count: 1, falsy_count: 2 }
# CLAM-WIT: hint=induction_or, or, logical, disjunction, any_condition
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Logic::Induction::Or;
use strict;
use warnings;

# CLAM-WIT: name=Certainty
# CLAM-WIT: version=1.0.0
# CLAM-WIT: about=Mark or propagate certainty through a derivation chain
# CLAM-WIT: usage=Input: { claim: "code is safe", level: "certain" } Output: { certified: "code is safe", level: "certain", valid: true }
# CLAM-WIT: hint=deduction_certainty, certainty, confidence, propagation, levels
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Logic::Deduction::Certainty;
use strict;
use warnings;

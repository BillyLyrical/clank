# CLAM-WIT: name=Encode
# CLAM-WIT: version=1.0.0
# CLAM-WIT: about=Encode constraints into DIMACS CNF format
# CLAM-WIT: usage=Input: { variables: { A: [1,2,3], B: [1,2,3] }, constraints: [...] } Output: { ok: true, dimacs: "p cnf 6 5\n...", vars: {...}, num_vars: 6, num_clauses: 5 }
# CLAM-WIT: hint=sat_encode, encode, cnf, dimacs, constraints, variables
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Logic::Sat::Encode;
use strict;
use warnings;

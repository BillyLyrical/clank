# CLANK-WIT: name=Constraints
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Output validation — checks LLM output against practical schemas before emission
# CLANK-WIT: usage=Auto-validates on message_end bus event. Register custom constraints via API.
# CLANK-WIT: hint=constraints, validation, output quality, contradiction detection
...
package Clank::Wits::Neuro::Constraints;
use strict;
use warnings;
use Clank::Util qw(now_ms jencode);

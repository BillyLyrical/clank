# CLANK-WIT: name=NeuroIntegration
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Bidirectional LLM <-> world model integration — context injection, validation, knowledge extraction
# CLANK-WIT: usage=Auto-runs on context/message_end/agent_end bus events. Three phases: inject facts, validate output, extract knowledge.
# CLANK-WIT: hint=neurosymbolic, world model, context injection, validation, knowledge extraction
...
package Clank::Wits::Neuro::NeuroIntegration;
use strict;
use warnings;

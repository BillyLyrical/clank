...
# CLANK-WIT: about=Execute SELECT queries — fetch rows, columns, single value
# CLANK-WIT: usage=Input: { conn_id: "sqlite:./data.db", sql: "SELECT * FROM users", fetch: "all" } Output: { rows: [...], count: N, columns: [...] }
# CLANK-WIT: hint=database query, select, sql, read
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Db::Query;
use strict;
use warnings;

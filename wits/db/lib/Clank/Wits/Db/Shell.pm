# CLANK-WIT: name=Shell
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Interactive database shell — REPL for exploring and managing databases
# CLANK-WIT: usage=Input: { action: "start", db: "my.db" } Output: { ok: true, message: "..." }
# CLANK-WIT: hint=database shell, repl, interactive, explore
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Db::Shell;
use strict;
use warnings;

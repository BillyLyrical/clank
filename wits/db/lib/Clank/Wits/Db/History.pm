# CLANK-WIT: name=History
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Query history — browse, search, and re-execute previous queries
# CLANK-WIT: usage=Input: { action: "list" } Output: { ok: true, history: [...], count: N }
# CLANK-WIT: hint=database history, query log, search, rerun
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Db::History;
use strict;
use warnings;

# CLANK-WIT: name=Connect
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Connect to databases — SQLite, MySQL, PostgreSQL
# CLANK-WIT: usage=Input: { driver: "sqlite", database: "./data.db" } Output: { ok: true, driver: "sqlite", dbh: <dbh> }
# CLANK-WIT: hint=database connect, dbi, sqlite, postgresql, mysql
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Db::Connect;
use strict;
use warnings;

# CLANK-WIT: name=Execute
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Execute INSERT, UPDATE, DELETE — with transaction support
# CLANK-WIT: usage=Input: { conn_id: "sqlite:./data.db", sql: "INSERT INTO users (name) VALUES (?)", params: ["Alice"] } Output: { ok: true, rows_affected: 1, last_insert_id: 5 }
# CLANK-WIT: hint=database execute, insert, update, delete, write, transaction
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Db::Execute;
use strict;
use warnings;

# CLAM-WIT: name=Schema
# CLAM-WIT: version=1.0.0
# CLAM-WIT: about=Inspect database schema — tables, columns, indexes, constraints
# CLAM-WIT: usage=Input: { conn_id: "sqlite:./data.db", action: "tables" } Output: { tables: ["users", "posts"], count: 2 }
# CLAM-WIT: hint=database schema, introspect, tables, columns, indexes
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Db::Schema;
use strict;
use warnings;

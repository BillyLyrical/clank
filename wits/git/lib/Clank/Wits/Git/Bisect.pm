# CLANK-WIT: name=Bisect
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Automated binary search for bug introduction — find which commit broke it
# CLANK-WIT: usage=Input: { path: ".", good: "abc123", bad: "HEAD", test: "prove -l t/test.t" } Output: { found: true, culprit: "def456", message: "...", steps: 5 }
# CLANK-WIT: hint=git bisect, binary search, find bad commit, regression
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Git::Bisect;
use strict;
use warnings;

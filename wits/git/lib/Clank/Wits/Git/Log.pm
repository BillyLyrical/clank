...
# CLANK-WIT: about=Show git log with stats, author breakdown, and date filtering
# CLANK-WIT: usage=Input: { path: ".", count: 10 } Output: { commits: [...], by_author: {...}, summary: {...} }
# CLANK-WIT: hint=git log, commit history, author stats, date range
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Git::Log;
use strict;
use warnings;

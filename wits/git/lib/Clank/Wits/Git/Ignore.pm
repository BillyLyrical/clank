# CLANK-WIT: name=Ignore
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Manage .gitignore file
# CLANK-WIT: usage=Input: { path: ".", action: "list" } Input: { path: ".", action: "add", pattern: "*.log" } Output: { patterns: [...], added: true }
# CLANK-WIT: hint=gitignore, ignore patterns, exclude files from tracking
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Git::Ignore;
use strict;
use warnings;

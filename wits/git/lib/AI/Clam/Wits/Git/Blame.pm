...
# CLAM-WIT: about=Show git blame with author stats and ownership breakdown
# CLAM-WIT: usage=Input: { path: ".", file: "lib/Clam/Core.pm" } Output: { lines: [...], by_author: {...}, stats: {...} }
# CLAM-WIT: hint=git blame, line ownership, author stats, code history
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Git::Blame;
use strict;
use warnings;

...
# CLAM-WIT: about=Stash changes
# CLAM-WIT: usage=Input: { path: ".", action: "save", message: "work in progress" } Input: { path: ".", action: "list" } Input: { path: ".", action: "pop" } Output: { ok: true, stash: "stash@{0}" }
# CLAM-WIT: hint=git stash, save changes, restore stashed changes
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Git::Stash;
use strict;
use warnings;

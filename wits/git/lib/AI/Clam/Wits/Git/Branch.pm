# CLAM-WIT: name=Branch
# CLAM-WIT: version=1.0.0
# CLAM-WIT: about=List branches or create new branch
# CLAM-WIT: usage=Input: { path: ".", action: "list" } Input: { path: ".", action: "create", name: "feature-x" } Output: { branches: [...], current: "main" }
# CLAM-WIT: hint=git branch, list branches, create branch, checkout, switch
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Git::Branch;
use strict;
use warnings;

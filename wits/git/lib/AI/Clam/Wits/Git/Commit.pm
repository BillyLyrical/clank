# CLAM-WIT: name=Commit
# CLAM-WIT: version=1.0.0
# CLAM-WIT: about=Stage and commit changes
# CLAM-WIT: usage=Input: { path: ".", message: "commit message", files: ["file1.txt"] } Output: { ok: true, hash: "abc123" }
# CLAM-WIT: hint=git commit, stage files, create commit
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Git::Commit;
use strict;
use warnings;

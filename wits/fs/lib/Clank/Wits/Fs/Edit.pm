...
# CLANK-WIT: about=Edit file with backup and atomic operation
# CLANK-WIT: usage=Input: { path: "/tmp/test.txt", search: "old", replace: "new" } Output: { ok: true, replacements: 3 }
# CLANK-WIT: hint=Creates backup before edit. Atomic: edit to temp, then rename.
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Fs::Edit;
use strict;
use warnings;

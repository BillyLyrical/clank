# CLANK-WIT: name=Editor
# CLANK-WIT: version=1.0.0
# CLANK-WIT: about=Open $EDITOR for editing files or text blocks — vim, nano, etc.
# CLANK-WIT: usage=Input: { file: "lib/Foo.pm" } Input: { content: "sub foo { }" } Input: { file: "/tmp/block.txt", content: "# Edit this:\n" } Output: { ok: true, content: "...", changed: true }
# CLANK-WIT: hint=Spawns $EDITOR (vim, nano, etc.) for interactive editing. Works with files or temporary text blocks. Returns edited content for further processing.
# CLANK-WIT: author=Clank
# CLANK-WIT: license=Artistic-2.0
package Clank::Wits::Fs::Editor;
use strict;
use warnings;
use File::Temp;

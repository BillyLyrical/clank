...
# CLAM-WIT: about=Search for files by pattern or content
# CLAM-WIT: usage=Input: { path: ".", pattern: "*.wit", contains: "source" } Output: { files: [...], count: 5 }
# CLAM-WIT: hint=Read-only. Finds files matching criteria.
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Fs::Search;
use strict;
use warnings;

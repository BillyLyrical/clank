# CLAM-WIT: name=Delete
# CLAM-WIT: version=1.0.0
# CLAM-WIT: about=Delete file with backup before removal
# CLAM-WIT: usage=Input: { path: "/tmp/test.txt", backup: true } Output: { ok: true, backup: "/tmp/clam_backups/test.txt.20250629" }
# CLAM-WIT: hint=Creates backup before deletion. Supports dry_run to preview.
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Fs::Delete;
use strict;
use warnings;

...
# CLAM-WIT: about=Copy file with backup of destination
# CLAM-WIT: usage=Input: { source: "/path/a.txt", dest: "/path/b.txt" } Output: { ok: true, bytes: 1234 }
# CLAM-WIT: hint=Backs up destination if it exists.
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Fs::Copy;
use strict;
use warnings;

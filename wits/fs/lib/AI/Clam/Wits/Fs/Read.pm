...
# CLAM-WIT: about=Read file contents safely (read-only)
# CLAM-WIT: usage=Input: { path: "/home/user/file.txt", max_size: 1048576 } Output: { content: "...", size: 1234, lines: 50 }
# CLAM-WIT: hint=Read-only. Validates path, checks size limit. No write operations.
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Fs::Read;
use strict;
use warnings;

...
# CLAM-WIT: about=Write file with backup and atomic operation
# CLAM-WIT: usage=Input: { path: "/tmp/test.txt", content: "hello", backup: true } Output: { ok: true, backup: "/tmp/clam_backups/test.txt.20250629", bytes: 5 }
# CLAM-WIT: hint=Creates backup before write. Atomic: write to temp, then rename.
# CLAM-WIT: author=CLAM
# CLAM-WIT: license=Artistic-2.0
package AI::Clam::Wits::Fs::Write;
use strict;
use warnings;

package AI::Clam::Providers;
use strict; use warnings;
# Provider registry + factory. API keys are never logged or persisted here.

my %KNOWN = (
    lmstudio        => 'AI::Clam::Provider::LMStudio',
    'openai-compat' => 'AI::Clam::Provider::OpenAICompat',
    ollama          => 'AI::Clam::Provider::Ollama',
    openai          => 'AI::Clam::Provider::OpenAI',
    anthropic       => 'AI::Clam::Provider::Anthropic',
    gemini          => 'AI::Clam::Provider::Gemini',
    azure           => 'AI::Clam::Provider::Azure',
    mock            => 'AI::Clam::Provider::Mock',
);

sub known { sort keys %KNOWN; }

# Class method: AI::Clam::Providers->create(%o). (Written as a plain function it

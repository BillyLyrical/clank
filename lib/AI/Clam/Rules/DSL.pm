# AI::Clam::Rules::DSL — lightweight rule syntax that compiles to Perl closures.
# Users write:   when <pattern> → <action>
# Engine stores: AI::Clam::Rules::Rule objects with code refs.
#
# Format:
...
package AI::Clam::Rules::DSL;
use strict;
use warnings;

# Parse a DSL string into an arrayref of AI::Clam::Rules::Rule.
sub parse {
    my ($class, $text) = @_;
    my @rules;
    my @lines = split /\n/, $text;
...
# Compile a DSL rule into a AI::Clam::Rules::Rule with a closure action.
sub _build_rule {

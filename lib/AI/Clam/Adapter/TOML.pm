# AI::Clam::Adapter::TOML — compat shim for ported declarative wits that parse or
# emit TOML at runtime (e.g. fs.snapshot).  Delegates to AI::Clam::Wit::File's
# parser; the encoder covers the same subset (scalars, arrays of scalars,
# nested hashes as [table] sections).
package AI::Clam::Adapter::TOML;
use strict;
use warnings;
...
sub parse_toml {
    my ($str) = @_;
    return AI::Clam::Wit::File::parse_toml($str, path => 'runtime');
}

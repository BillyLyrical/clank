...
package AI::Clam::Store;
use strict;
use warnings;
use DBI;
use AI::Clam::Util qw(uuid4 now_ms jencode jdecode ensure_dir);
...
sub new {
    ...
    }) or die "AI::Clam::Store: cannot open $path: $DBI::errstr";
...
CREATE TABLE IF NOT EXISTS kv (
  ...
  value TEXT
    ...
    # Facts: shared blackboard state for AI::Clam::Rules. One row per asserted fact;
...
# --- facts (AI::Clam::Rules blackboard) ----------------------------------------
...
# of truth; AI::Clam::Rules::Engine keeps an in-memory working set over it.

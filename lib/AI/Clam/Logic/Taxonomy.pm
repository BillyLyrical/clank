# AI::Clam::Logic::Taxonomy — hierarchical classification for entities, beliefs, and goals.
#
...
package AI::Clam::Logic::Taxonomy;
use strict;
use warnings;
...
sub new {
    my ($class, %args) = @_;
    my $world_model = $args{world_model} or die "AI::Clam::Logic::Taxonomy requires world_model\n";
...
=head1 SYNOPSIS
  ...
  my $tx = AI::Clam::Logic::Taxonomy->new(
      world_model => $wm,             # required: AI::Clam::WorldModel
      bus         => $bus,            # optional
...
AI::Clam::Logic::Taxonomy provides hierarchical classification across the world model.

package AI::Clam::Session::SystemPrompt;
...
sub build {
    ...
    my $prompt = <<"EOT";
You are an expert coding assistant operating inside clam, a coding agent harness. You help users by reading files, executing commands, editing code, and writing new files.

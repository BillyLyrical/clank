...
Clam::Rules - Rule engine facade with forward/backward chaining, negation,
...
=head1 SYNOPSIS
  ...
  my $store = Clam::Store->new(db => 'clam.db');
...
Clam::Rules is the rule engine facade. It parses DSL rules, builds engines
over a shared SQLite fact store (Clam::Store), and provides multiple inference
...
Parse a rules-DSL program into an arrayref of Clam::Rules::Rule configs.
...
L<Clam::Rules::Engine>, L<Clam::Rules::Rule>, L<Clam::Rules::DSL>,
L<Clam::Store>

# Clam::Wit::Scanner — discovers installed wits via grep for # CLAM-WIT: markers.
# Populates the SQLite DB with wit metadata. One-time scan, then DB is the cache.
package Clam::Wit::Scanner;
use strict;
use warnings;
...
# $store is a Clam::Store object. $wits is arrayref from scan().

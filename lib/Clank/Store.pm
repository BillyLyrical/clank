...
use warnings;
use DBI;
use Clank::Util qw(uuid4 now_ms jencode jdecode ensure_dir);
...
sub new {
    ...
    }) or die "Clank::Store: cannot open $path: $DBI::errstr";
...
CREATE TABLE IF NOT EXISTS kv (
  ...
  value TEXT
    ...
    # Facts: shared blackboard state for Clank::Rules. One row per asserted fact;
...
SQL
    ...
    # Wit registry: tracks installed wits discovered via # CLANK-WIT: markers.
...
# of truth; Clank::Rules::Engine keeps an in-memory working set over it.

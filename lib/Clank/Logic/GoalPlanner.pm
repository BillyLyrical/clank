# Clank::Logic::GoalPlanner — goal decomposition and execution planning.
#
...
package Clank::Logic::GoalPlanner;
use strict;
use warnings;
...
sub new {
    my ($class, %args) = @_;
    my $world_model = $args{world_model} or die "Clank::Logic::GoalPlanner requires world_model\n";

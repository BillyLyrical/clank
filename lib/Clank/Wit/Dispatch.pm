# Clank::Wit::Dispatch — inter-wit execution, the object wits receive as
# $ctx{wits}.  Mirrors the clank-old Executor's execute-by-name semantics:

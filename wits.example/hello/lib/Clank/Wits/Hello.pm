# CLANK-WIT: name=Hello
# CLANK-WIT: version=1.0
# CLANK-WIT: about=Example wit showing tool, command, and bus hook registration
# CLANK-WIT: usage=Template for writing your own wits. Load to try it.
# CLANK-WIT: hint=Example: greet tool, /hello command, input tagging hook
...
#
# Layout: standard wit layout — lib/Clank/Wits/<Name>.pm
